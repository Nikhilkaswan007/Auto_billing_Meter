...
SERVER_URL = "http://192.168.43.27:8000"
PORT = "COM4"       # Windows example: COM4 / Linux: /dev/ttyUSB0
BAUD = 9600
# ----------------------------
...
def read_pzem(master):
    try:
        ...
        energy = (data[5] | (data[6] << 16)) / 1000.0  # convert Wh → kWh
        ...
        if data["status"] == "success":
            for cmd in data["commands"]:
                ...
                if command == "turn_off":
                    ...
                    success = True  # Replace with your GPIO/relay code
...
while True:
    ...
    check_commands()
    time.sleep(10)   # send data every 10 sec
